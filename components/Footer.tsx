...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className={`${bgClass} text-white pt-24 pb-12 relative overflow-hidden transition-colors duration-500`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="space-y-8">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-bold text-islamic-gold-500 uppercase tracking-widest mt-1">
                  Islami & Qurani
                </span>
              </div>
            </div>
            <p className="text-sm leading-relaxed text-white/80 font-medium">
              Membentuk intelektual muslim yang unggul, berkarakter Qurani, dan
              berdaya saing global melalui pendidikan berkualitas terpadu.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/lpialhidayahkauman"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-white/5 rounded-2xl hover:bg-islamic-gold-500 hover:text-white transition-all border border-white/10"
              >
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-semibold">
              <li>
                <Link
                  to="/berita"
                  className="hover:text-islamic-gold-500 transition-colors flex items-center gap-2 group"
                >
                  <div className="w-1.5 h-1.5 rounded-full bg-islamic-gold-500 group-hover:scale-150 transition-transform"></div>{" "}
                  Warta Sekolah
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-6 text-sm">
              <li className="flex items-start group">
                <div className="p-2 bg-white/5 rounded-xl mr-4 group-hover:bg-islamic-gold-500 group-hover:text-white transition-all">
                  <MapPin className="w-5 h-5 text-islamic-gold-500 group-hover:text-inherit" />
                </div>
              ...
              <li className="flex items-center group">
                ...
                <a href="https://wa.me/6281559861036">
                  <span className="font-bold text-white">081559861036 (Bu Mei)</span>
                </a>
              </li>
              <li className="flex items-center group">
                <div className="p-2 bg-white/5 rounded-xl mr-4 group-hover:bg-islamic-gold-500 group-hover:text-white transition-all">
                  <Mail className="w-5 h-5 text-islamic-gold-500 group-hover:text-inherit" />
                </div>
                <span className="font-bold text-white">
                  lpialhidayahkauman@gmail.com
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 mt-24 pt-12 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-bold uppercase tracking-widest text-white/60">
          <p>
            &copy; {new Date().getFullYear()} {SCHOOL_NAME}. Berkhidmat untuk
            pendidikan bangsa.
          </p>
          <div className="flex gap-8">
            <a href="#" className="hover:text-islamic-gold-500">
              Kebijakan Privasi
            </a>
            <a href="#" className="hover:text-islamic-gold-500">
              Syarat & Ketentuan
