...
const About: React.FC = () => {
  ...
  const renderStruktur = () => (
    <div className="space-y-16 animate-fadeIn text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mt-16 md:mt-24 max-w-6xl mx-auto px-4">
        ...
        <div className="group relative">
          ...
          <div className="relative bg-white p-4 md:p-6 rounded-[2.5rem] shadow-xl ring-1 ring-slate-900/5">
            <div className="relative overflow-hidden rounded-[2rem] group-hover:shadow-inner transition-all">
              <img
                src="/strukturorganisasi.jpg"
                alt="Struktur Organisasi"
                className="w-full h-auto object-contain transform group-hover:scale-105 transition-transform duration-700 ease-in-out"
                onClick={() => window.open('/strukturorganisasi.jpg', '_blank')}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-8 cursor-pointer pointer-events-none">
                <p className="text-white font-bold text-lg">Klik untuk memperbesar</p>
              </div>
            </div>
            <div className="mt-6 text-center">
              <h3 className="text-2xl font-black text-slate-800 mb-2">Struktur Organisasi</h3>
              <div className={`h-1.5 w-16 mx-auto ${theme.bg} rounded-full`}></div>
            </div>
          </div>
        </div>

        {/* Struktur Tata Usaha Image */}
        <div className="group relative">
          ...
          <div className="relative bg-white p-4 md:p-6 rounded-[2.5rem] shadow-xl ring-1 ring-slate-900/5">
            <div className="relative overflow-hidden rounded-[2rem] group-hover:shadow-inner transition-all">
              <img
                src="/strukturtatausaha.jpg"
                alt="Struktur Tata Usaha"
                className="w-full h-auto object-contain transform group-hover:scale-105 transition-transform duration-700 ease-in-out"
                onClick={() => window.open('/strukturtatausaha.jpg', '_blank')}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-8 cursor-pointer pointer-events-none">
                <p className="text-white font-bold text-lg">Klik untuk memperbesar</p>
              </div>
            ...
            <div className="mt-6 text-center">
              <h3 className="text-2xl font-black text-slate-800 mb-2">Struktur Tata Usaha</h3>
              <div className={`h-1.5 w-16 mx-auto ${theme.bg} rounded-full`}></div>
            </div>
          </div>
        </div>
