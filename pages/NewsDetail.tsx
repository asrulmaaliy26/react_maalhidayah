...
const NewsDetail: React.FC = () => {
    ...
    const authorName = news.author || ('Redaksi ' + (news.jenjang || 'MA Al-Hidayah'));
    const unitName = news.fakultas || news.jenjang || 'MA Al-Hidayah';

    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                title: news.title || 'Berita MA Al-Hidayah',
